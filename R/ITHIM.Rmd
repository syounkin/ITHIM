...
```{r ICD, fig.width = 12}
Data.IDC.Codes <- read.csv(file="./data/IDC_Codes_key.csv", header = TRUE, colClasses = c("factor","factor","factor"), na.string = "")
...
p <- ggplot(data.frame(disease = Data.Mortality$CauseofDeathITHIM), aes(disease))
p + geom_bar()
