...
#' @aliases createITHIM
#' @export
setMethod("createITHIM", signature(activeTransportFile = "character", GBDFile = "character", FFile = "character"), function(activeTransportFile, GBDFile, FFile){
    ITHIM <- createITHIMFunction(activeTransportTimeFile = activeTransportFile, GBDFile = GBDFile, FFile = FFile)
    return(ITHIM)
})
## #' @rdname createITHIM-methods
## #' @aliases createITHIM
